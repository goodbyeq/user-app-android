...
package com.beatus.selfkart.mapsanimations;
...
public class MapRadar {
    ...
    public MapRadar(GoogleMap googleMap, LatLng latLng, Context context) {
        ...
        outerDrawable = (GradientDrawable) context.getResources().getDrawable(R.drawable.mapsanimbackground);
    }
